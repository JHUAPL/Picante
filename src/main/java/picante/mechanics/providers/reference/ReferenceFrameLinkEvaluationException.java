...
/**
 * Runtime exception indicating the reference implementation of the frame provider interface was
 * unable to successfully link two requested frames at the identified time.
 */
public class ReferenceFrameLinkEvaluationException extends FrameEvaluationException {
  ...
  /**
   * Construct a reference implementation of the frame provider interface link exception, when the
   ...
   *        connected.
   */
  ReferenceFrameLinkEvaluationException(FrameID from, FrameID to, double time,
