...
/**
 * Runtime exception indicating the reference implementation of the ephemeris provider interface was
 * unable to properly respond to a request to link two bodies together at the identified time.
 */
public class ReferenceEphemerisLinkEvaluationException extends EphemerisEvaluationException {
  ...
  /**
   * Construct a reference implementation of the ephemeris provider interface link exception, when
   ...
   *        connected
   */
  ReferenceEphemerisLinkEvaluationException(EphemerisID target, EphemerisID observer, double time,
