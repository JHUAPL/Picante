...
public class SPKType12Test {
  ...
  private SPKType12 segment;
  private SPKType12 realSegment5d;

  private Retrievable<StateVector> mockTable;

  @BeforeClass
  public static void setUpBeforeClass() throws Exception {
    daf5d = DAFFactory.createDAF(SPKType12Test.class.getResourceAsStream("type12_5d.bsp"));

    spk5d = new SPK("type12_5d.bsp", new DAFBackedSPKContent(daf5d, SPKSegmentFactory.VALIDATING));
  ...
  public void setUp() throws Exception {
    ...
    segment = new SPKType12("SEGMENTNAME", 10, 20, 30, 40.0, 50.0, mockTable, 60, 70, 2);
    // constructs a segment from a real spk file
    realSegment5d = (SPKType12) spk5d.getSegment(0);

  }

  @Test
  public void testSPKType12() {
  ...
  public void testGetType() {
    assertEquals(12, segment.getType());
    assertEquals(12, realSegment5d.getType());
  }
  ...
  public void testGetPosition() {
    ...
    List<StateVector> spiceStateVectors =
        readSpiceTest(SPKType12Test.class.getResourceAsStream("type12_5d_spice.txt"));
  ...
  public void testGetState() {
    ...
    for (double et = 0.0; et < 29.0; et = et + 0.1) {
      ...
      assertComponentEquals(spiceStateVectors.get(count).getVelocity(), buffer.getVelocity(), TOL);
