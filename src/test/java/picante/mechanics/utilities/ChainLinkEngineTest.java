...
public class ChainLinkEngineTest {
  ...
  private ChainLinkEngine<EngineTestCodes, Function> engine;
  ...
  private void createEngineFromFunctionsList() {
    engine = new ChainLinkEngine<>(functions, EngineTestCodes.createProvider(),
        EngineTestCodes.SEPARATOR, EngineTestCodes.BROKEN_LINK);
  }
